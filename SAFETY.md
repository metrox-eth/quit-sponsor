...
Normal withdrawal includes a temporarily more productive cough, irritability, hunger, and sleep changes. Not normal, refer immediately:

- blood in phlegm
- fever
- breathlessness at rest, or chest pain

When in doubt, the doctor visit is the cheap option.
...
Smoking (tobacco, joints rolled with tobacco, and cannabis co-use) is the scope. Poly-substance dependence, alcohol withdrawal (which can be medically dangerous), and opioid dependence need professional care: support the person, and insist on the clinician.

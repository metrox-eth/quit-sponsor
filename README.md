...
2. The sponsor decision tree: the three-clause contract (call before, slips are data, witness never sermon), the purge ritual, the wave triage, the slip protocol with attribution coaching and escalation on repetition, compound high-risk situations and field removal, the daily scaffold, the two-year check-in arc, social pressure scripts, writing cycles, replacement-addiction screening, the timestamped logbook.
...
- Zero shame. Slips are data. The counter restarts, nothing else changes.
